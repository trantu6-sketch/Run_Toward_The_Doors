...
public class InteractiveCube : MonoBehaviour
{
    ...
    [Tooltip("Tích vào đây để Cube tự động chạy đi chạy lại trên trục Y mà không cần Player")]
    ...
    void Start()
    {
        ...
        // Tính toán vị trí đích đến trên trục Y
        endPosition = startPosition + new Vector3(0, yOffset, 0);
