...
public class SlidingTrapCubeZ : MonoBehaviour
{
    [Header("Cài đặt bẫy trượt trục Z")]
    [Tooltip("Khoảng cách thay đổi trục Z. Số dương để di chuyển tới trước, số âm lùi sau.")]
    ...
    void OnCollisionEnter(Collision collision)
    {
        ...
        if (collision.gameObject.GetComponent<PlayerMove>() != null)
        {
            ...
            if (collision.transform.position.y > transform.position.y)
            {
                ...
                if (!loop)
                {
                    // Đổi vị trí mục tiêu (thêm zOffset vào trục Z)
